...
type SeasonRequest struct {
	...
	Teams     []uuid.UUID `json:"teams" validate:"required,min=2,max=100,unique_uuids,dive,required" swaggertype:"array,string" example:"013952a5-87e1-4d26-a312-09b2aff54241,7b6cdb33-3bc6-4b0c-bac2-82d2a6bc6a97"`
}
