...
type GameService interface {
	...
	GetAll(ctx context.Context, seasonID, stageID uuid.UUID) ([]db.Game, error)
...
func (s *gameService) GetAll(ctx context.Context, seasonID, stageID uuid.UUID) ([]db.Game, error) {
	var games []db.Game
